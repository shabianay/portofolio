    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
                ...
                <h2 class="text-2xl md:text-3xl font-bold text-gray-400 mt-2" x-data="{ roles: ['Web Developer', 'WordPress Developer', 'UI/UX Designer', 'Product Digital Designer'], current: 0 }" x-init="setInterval(() => current = (current + 1) % roles.length, 2000)">
                ...
                <p class="mt-6 text-lg text-gray-400 leading-relaxed max-w-xl">
                    I'm a <strong class="text-white">Junior Website & WordPress Developer</strong> with a strong passion for UI/UX design. I turn ideas into responsive, user-centered websites blending code, creativity, and communication.
                </p>
                <div class="flex flex-wrap gap-4 mt-8">
                    <a href="{{ route('portfolios') }}" class="btn-accent">View Portfolio</a>
                    <a href="{{ route('contact') }}" class="btn-accent !bg-transparent !text-white border border-custom hover:border-accent">Contact Me</a>
                </div>
            </div>
            <div class="relative">
                <div class="aspect-square rounded-2xl overflow-hidden border border-custom max-w-md mx-auto">
                    <img src="{{ asset('storage/portfolio/shabian-profile.png') }}" alt="Shabian Arsyl Yonanta" class="w-full h-full object-cover">
                </div>
            </div>
        </div>
    </div>
...
<section class="py-20">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            @php
                $homeServices = [
                    ['num' => '01', 'title' => 'Web Developer', 'desc' => 'Transforming design ideas into fully functional, user-friendly websites is what I do best.'],
                    ['num' => '02', 'title' => 'WordPress Developer', 'desc' => 'I create flexible, scalable WordPress sites optimized for performance and SEO.'],
                    ['num' => '03', 'title' => 'Product Digital Designer', 'desc' => 'I connect business goals with user needs to design meaningful product experiences.'],
                    ['num' => '04', 'title' => 'UI/UX Designer', 'desc' => 'Designing user-centered experiences that feel natural, functional, and memorable.'],
                ];
            @endphp
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <a href="{{ route('portfolios.show', $portfolio->slug) }}" class="card overflow-hidden group">
                <div class="aspect-video bg-dark-2 overflow-hidden">
                    <img src="/storage/portfolio/{{ str_replace('storage/portfolio/', '', $portfolio->image) }}" alt="{{ $portfolio->title }}" class="w-full h-full object-cover group-hover:scale-105 transition duration-500" loading="lazy">
                </div>
                <div class="p-5">
            ...
            <div class="card p-8 flex flex-col justify-between">
                <div>
                    ...
                    <div class="border-t border-custom mt-5 pt-5">
                        ...
                        <p class="text-gray-300 leading-relaxed text-justify">I merge design thinking with technical skills to build responsive WordPress websites, craft user-focused interfaces, and deliver meaningful digital experiences. With a passion for both aesthetics and functionality, I help bring ideas to life whether it's a custom website, intuitive UI/UX, or a visual concept that speaks.</p>
                    </div>
                </div>
            ...
            <div class="grid grid-cols-1 gap-6">
                <div class="card p-6">
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center gap-4 p-4 rounded-xl bg-dark border border-custom">
                            <img src="/storage/portfolio/wp/logo_TSI_white-removebg-preview.png" alt="The Solution ID" class="w-12 h-12 object-contain bg-white rounded p-1">
                            <div>
                        ...
                        <div class="flex items-center gap-4 p-4 rounded-xl bg-dark border border-custom">
                            <img src="/storage/portfolio/wp/channels4_profile-removebg-preview-e1749042810174.png" alt="Bangkit Academy" class="w-12 h-12 object-contain bg-white rounded p-1">
                            <div>
                        ...
                        <div class="flex items-center gap-4 p-4 rounded-xl bg-dark border border-custom">
                            <img src="/storage/portfolio/wp/soca_ai_logo-removebg-preview.png" alt="SOCA AI" class="w-12 h-12 object-contain bg-white rounded p-1">
                            <div>
                ...
                <div class="card p-6">
                    ...
                    <div class="flex items-start gap-4 p-4 rounded-xl bg-dark border border-custom">
                        <img src="/storage/portfolio/wp/Group-3-1-150x150.png" alt="UNESA" class="w-12 h-12 object-contain bg-white rounded p-1">
                        <div>
                            <h5 class="font-semibold">Bachelor of Applied Computer Science @Surabaya State University</h5>
                            <p class="text-xs text-gray-500 mb-2">GPA 3.86/4.00</p>
                            <p class="text-sm text-gray-400"><strong>Thesis (Diploma):</strong> <a href="https://ejournal.unesa.ac.id/index.php/jurnal-manajemen-informatika/article/view/60964" target="_blank" class="text-accent underline">Web-Based Decision Support System for Mental Health Screening Using AHP Method.</a></p>
                        </div>
                    </div>
                </div>
            </div>
...
<section class="py-20 border-t border-custom">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        @php
            $partners = [
                ['Lateevadinamika', 'Group-17.png'],
                ['Vokasi UNESA', 'Logo-vokasi-unesa.png'],
                ['UPN Jatim', 'Group-17-1.png'],
                ['Masa Depan Hukum', 'Group-15-2.png'],
                ['RS Sampang', 'Group-22.png'],
                ['Arsip Surat', 'Group-15-3.png'],
                ['Berdonor', 'Group-16-1.png'],
                ['Shellfish', 'Logo-Shellfish.png'],
                ['SMN TAX', 'SMN-TAX.png'],
                ['Cibrievco', 'Group-17-2.png'],
                ['Sepatu Andalas', 'Group-18.png'],
                ['UD Sumber Bangunan', 'Group-19-1.png'],
                ['Koepilihanku', 'Group-20.png'],
                ['Mindful', 'Logo-Mindful-2.png'],
                ['Serenity', 'Group-23.png'],
                ['Sibatur', 'Logo-Sibatur.png'],
                ['Bismika Interior', 'Logo-Bismika-Interior.png'],
                ['Seroom.id', 'Logo-Seroom.id_.png'],
            ];
        @endphp
        <div x-data="{ active: 0, total: {{ ceil(count($partners) / 3) }} }" x-init="setInterval(() => active = (active + 1) % total, 2500)" class="relative overflow-hidden">
            <div class="flex transition-transform duration-700 ease-in-out" :style="`transform: translateX(-${active * 100}%)`">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 min-w-full">
                    ...
                    <div class="bg-dark-2 border border-custom rounded-2xl flex items-center justify-center h-80 p-8">
                        <img src="/storage/portfolio/partners/{{ $partner[1] }}" alt="{{ $partner[0] }}" class="max-h-64 max-w-full object-contain">
                    </div>
                    @endforeach
                </div>
                @endforeach
            ...
            <div class="flex justify-center gap-2 mt-6">
                ...
                <button type="button" @click="active = {{ $i }}" class="w-3 h-3 rounded-full transition" :class="active === {{ $i }} ? 'bg-accent' : 'bg-gray-600'"></button>
                @endfor
            </div>
        </div>
    </div>
...
<section class="py-20 border-t border-custom">
    <div class="max-w-4xl mx-auto text-center px-4">
        ...
        <p class="text-gray-400 mt-4 max-w-lg mx-auto">Have a project in mind? Let's discuss how we can bring your ideas to life.</p>
