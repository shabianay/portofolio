                    ...
                    <form action="{{ route('admin.certificates.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="provider" name="provider" type="text" class="mt-1 block w-full" :value="old('provider')" />
                            ...
                            <div>
                                ...
                                <select id="type" name="type" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                                    <option value="image" {{ old('type') == 'image' ? 'selected' : '' }}>Academic / Non-Academic Certificate (Image)</option>
                                    <option value="url" {{ old('type') == 'url' ? 'selected' : '' }}>E-Course / Online Course (External URL)</option>
                                </select>
